...
+(Facebook * )getFacebooksingletonobjectWithAppID:(NSString *)aid andDelegate:(id<FBSessionDelegate>)del{
    static dispatch_once_t once;
    static Facebook *objFB;
    dispatch_once(&once, ^ { objFB  = [[Facebook alloc] initWithAppId:aid andDelegate:del]; });
    return objFB;
}
